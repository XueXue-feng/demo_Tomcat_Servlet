jQuery(function ($) {
    ...
    $(document).ready(function () {
        ...
        function parallaxImage() {
            ...
            TweenMax.to($(".top-image-wrapper"), .8, {
                force3D: true,
                scale: 1.05,
                opacity: 1,
                delay: 0,
        ...
        function pageMap() {
            ...
            var mapId = document.getElementById('container');

            if (mapId) {
                /*var map = new AMap.Map('container', {
                    resizeEnable: true, //
                    zoom: 12, //
                    center: [109.00741, 34.283077], //位置坐标
                    mapStyle: 'amap://styles/grey',
                });
                var marker = new AMap.Marker({
                    position: new AMap.LngLat(109.00741, 34.283077),
                    title: ''
                });
                map.add(marker);*/
        ...
        function linkLoad() {
            $("a").on('click', function (e) {
                ...
                function pageLinkLoad() {
                    ...
                    TweenMax.to($('.page-loading'), .5, {
                        css: {display: 'block', opacity: 1, top: "0%"},
                        onComplete: loadCursor,
                        ease: Quad.easeInOut
                    });
                ...
                function workLinkLoad() {
                    TweenMax.to($('.sub-loading'), .5, {
                        css: {display: 'block', opacity: 1},
                        onComplete: loadCursor,
                        ease: Quad.easeInOut
                    });
                    TweenMax.to($('.swiper-slide-content p'), .5, {
                        css: {top: "500px", opacity: 0},
                        ease: Quad.easeInOut
                    });
                    TweenMax.to($('.swiper-slide-content h1'), .5, {
                        css: {top: "500px", opacity: 0},
                        ease: Quad.easeInOut
                    });
            ...
            function loadPageContent(url) {
                ...
                var getData = $.get(url, function (response) {
                    ...
                    TweenMax.to($('.page-loading'), .5, {
                        css: {display: 'none', opacity: 0, top: "100%"},
                        ease: Quad.easeInOut
                    });
                    $('#cursor').removeClass('cursor-go');
